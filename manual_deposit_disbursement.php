...
// Register shortcode to display the deposit transactions table
function manual_deposit_transactions_shortcode() {
    ...
    if ($transactions) {
        ...
        echo '<thead><tr><th>Transaction ID</th><th>Deposit Address</th><th>Amount in WLD</th><th>Phone Number</th><th>MPESA Name</th><th>Status</th></tr></thead>';
        echo '<tbody>';
